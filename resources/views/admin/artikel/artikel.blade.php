            ...
            <div class="bg-latar px-3 border-t-[6px] border-sudah rounded-[4px]">
                ...
                <form action="/storeArtikel" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 border-t-2 pt-2">
                        ...
                        <input type="text" id="judul" name="judul" class="border bg-inherit rounded-md w-full px-2 py-0.5">
                    </div>
                    <div class="mb-3 ">
                        <label for="Isi" class="block">Isi Artikel</label>
                        <textarea  type="text" id="Isi" name="Isi" class="tinymce-editor bg-latar border rounded-md w-full px-2 "></textarea>
                    </div>
                    <div class="mb-3">
