                ...
                <form action="/storeProduk" method="POST">
                    ...
                    <div class="mb-3 border-t-2 pt-2">
                        ...
                        <input type="text" id="nama_layanan" name="nama_layanan"
                            class="border bg-inherit rounded-md w-full px-2 py-0.5">
                    </div>
                    <div class="mb-3">
                        <label for="desk" class="block">Deskripsi:</label>
                        <input type="text" id="desk" name="desk"
                            class="border rounded-md bg-inherit w-full px-2 py-0.5 my-0.5">
                    ...
                    <div class="mb-3 flex">
                        <div class="">
                            ...
                            <input type="number" id="harga" name="harga" class="border bg-inherit rounded-md w-full px-2 py-0.5"
                                min="1000" step="1000">
                        </div>
                        <div class="">
                            ...
                            <div class="ml-2 flex">
                                <label class="inline-flex items-center mr-4">
                                    <input type="radio" name="satuan" value="Pcs" class="form-radio bg-inherit  text-blue-500">
                                    <span class="ml-2">Pcs</span>
                                </label>
                                <label class="inline-flex items-center">
                                    <input type="radio" name="satuan" value="Kg" class="form-radio bg-inherit  text-blue-500">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="flex flex-row">
                            <input type="number" id="durasi" name="durasi" class="border bg-inherit rounded-md w-full px-2 py-0.5">
                ...
                <table class="w-full text-sm text-left ">
                    <thead>
                        <tr class="border-b-2 w-fit text-base ">
                            ...
                            <th scope="col" class="pt-4 pb-1 w-fit">Deskripsi</th>
                        ...
                        @foreach ($produks as $data)
                            <tr class=" object-center odd:bg-slate-200 even:bg-latar ">
                                ...
                                <td class="text-left w-fit ">
                                    ...
                                    <p class="font-light text-xs">
                                        {{ \Illuminate\Support\Str::limit($data->desk2, 50) }}
                                    </p>
                                </td>
                                <td class="pl-1 ">
