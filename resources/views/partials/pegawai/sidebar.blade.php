<aside id="logo-sidebar"
    class="  fixed top-5 left-3 bottom-3 z-50 w-64 h-screen bg-navbar1 transition-transform -translate-x-full sidebar  rounded-t-[5px] in-active sm:translate-x-0"
    aria-label="Sidebar">
